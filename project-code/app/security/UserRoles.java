...
public class UserRoles
{
    ...
    //Note: order this from high (a lot of permissions) to low (no permissions at all)
    private static List<UserRole> ALL_ROLES_CACHED = Arrays.asList(ROOT_ROLE,
                                                                  ADMIN_ROLE,
                                                                  BACKUP_ROLE,
                                                                  USER_ROLE,
                                                                  GUEST_ROLE);
	...
	if (ALL_ROLES_CACHED == null) {
	    ALL_ROLES_CACHED = Arrays.asList(ROOT_ROLE,
                                             ADMIN_ROLE,
                                             BACKUP_ROLE,
                                             USER_ROLE,
                                             GUEST_ROLE);
